...
function comboOption() {
    ...
    return {
        ...
        legend: { 
            top: 0, 
            data: ['Tổng SLSP layout', 'NS layout', 'Tỷ lệ (Tổng/KPI) %'],
        ...
        series: [
            { name: 'Tổng SLSP layout', type: 'bar', data: total, barMaxWidth: props.isMobile ? 16 : 32, emphasis: { focus: 'series' } },
            { name: 'NS layout', type: 'bar', data: kpi, barMaxWidth: props.isMobile ? 16 : 32, emphasis: { focus: 'series' } },
