        ...
        <a-form layout="inline" @submit.prevent>
            ...
            <a-form-item label="Ngày">
                <a-range-picker v-model:value="local.dateRange" format="DD/MM/YYYY" value-format="YYYY-MM-DD"
                    :allow-clear="true" style="min-width: 260px" @change="onDateChange" />
            </a-form-item>

            <!-- Xưởng -->
            <a-form-item label="Xưởng">
                <a-select v-model:value="local.workshop_id" :options="workshopOptions" allow-clear
                    placeholder="Chọn xưởng" style="min-width: 200px" show-search :filter-option="filterOption"
                    @change="onWorkshopChange" />
            </a-form-item>

            <!-- Tổ -->
            <a-form-item label="Tổ">
                <a-select v-model:value="local.team_id" :options="teamOptionsFiltered" allow-clear placeholder="Chọn tổ"
                    style="min-width: 200px" show-search :filter-option="filterOption" @change="onTeamChange" />
            </a-form-item>

            <!-- Đơn hàng -->
            <a-form-item label="Đơn hàng">
                <a-input v-model:value="local.order_no" placeholder="VD: ABC" allow-clear style="min-width: 160px" />
            </a-form-item>
